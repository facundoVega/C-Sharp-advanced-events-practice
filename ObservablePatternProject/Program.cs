...
namespace MyApp // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            securitySurveillanceHub.BuildEntryCutOffTimeReached();
    ...
    public class EmployeeNotify : Observer
    {
        ...
        public override void OnCompleted()
        {
            ...
            foreach(var externalVisitor in _externalVisitors)
            {
                ...
                Console.WriteLine($"{externalVisitor.Id, -6}{externalVisitor.FirstName, -15}{externalVisitor.LastName, -25}{externalVisitor.EntryDateTime.ToString("dd MMM yyyy hh:mm:ss"),-25}{externalVisitor.ExitDateTime.ToString("dd MMM yyyy hh:mm:ss tt"),-25}");
            }
            Console.WriteLine();
            Console.WriteLine();
        }
        ...
        public override void OnNext(ExternalVisitor value)
        {
            ...
            if(externalVisitor.EmployeeContactId == _employee.Id)
            {
                ...
                if(externalVisitorListItem == null)
                {
                    ...
                    Console.WriteLine($"{ _employee.FirstName } {_employee.LastName}, your visitor has arrived. Visitor Id({externalVisitor.Id}), FirstName({externalVisitor.FirstName}), LastName({externalVisitor.LastName}), entered the building, DateTime({externalVisitor.EntryDateTime.ToString("dd MMM yyyy hh:mm:ss tt")})");
    ...
    public class SecurityNotify : Observer
    {
        public override void OnCompleted()
        {
            ...
            foreach (var externalVisitor in _externalVisitors)
            {
                ...
                Console.WriteLine($"{externalVisitor.Id,-6}{externalVisitor.FirstName,-15}{externalVisitor.LastName,-25}{externalVisitor.EntryDateTime.ToString("dd MMM yyyy hh:mm:ss tt"),-25}{externalVisitor.ExitDateTime.ToString("dd MMM yyyy hh:mm:ss tt"),-25}");
            }
            Console.WriteLine();
            Console.WriteLine();
        }
        ...
        public override void OnNext(ExternalVisitor value)
        {
            ...
            { 
                ...
                Console.WriteLine($"Security Notification: Visitor Id({externalVisitor.Id}), FirstName({externalVisitor.FirstName}), LastName({externalVisitor.LastName}), entered the building, DateTime({externalVisitor.EntryDateTime.ToString("dd MMM yyyy hh:mm:ss")})");
            ...
            else
            {
                if(externalVisitorListItem.InBuilding == false)
                {
                    externalVisitorListItem.InBuilding = false;
                    externalVisitorListItem.ExitDateTime = externalVisitor.ExitDateTime;
                    Console.WriteLine($"Security notification:Visitor Id({externalVisitor.Id}), FirstName({externalVisitor.FirstName}), LastName({externalVisitor.LastName}), exited the building, DateTime({externalVisitor.ExitDateTime.ToString("dd MMM yyyy hh:mm:ss")})");
                    Console.WriteLine();
                }
            }
        }
    ...
    public class SecuritySurveillanceHub: IObservable<ExternalVisitor>
    {
        ...
        public void BuildEntryCutOffTimeReached()
        {
